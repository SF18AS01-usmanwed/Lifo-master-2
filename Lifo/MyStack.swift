...
extension MyQueueOfStrings {   //to make it easy to display the MyQueueOfStrings in a UITableView
    // Item 0 is the first one enqueued.
    // Item count - 1 is the most recently enqueued.
